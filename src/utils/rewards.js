...
export const PREMIUM_GACHA_POOL = [
  ...
  // ── 追加ポケモン 100種 ──
  // common (モンスターボール) 35種
  { id:'pg_pk11', type:'pokemon', pokeId:1,   name:'フシギダネ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk12', type:'pokemon', pokeId:4,   name:'ヒトカゲ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk13', type:'pokemon', pokeId:7,   name:'ゼニガメ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk14', type:'pokemon', pokeId:35,  name:'ピッピ',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk15', type:'pokemon', pokeId:37,  name:'ロコン',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk16', type:'pokemon', pokeId:58,  name:'ガーディ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk17', type:'pokemon', pokeId:63,  name:'ケーシィ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk18', type:'pokemon', pokeId:66,  name:'ワンリキー',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk19', type:'pokemon', pokeId:77,  name:'ポニータ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk20', type:'pokemon', pokeId:79,  name:'ヤドン',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk21', type:'pokemon', pokeId:92,  name:'ゴース',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk22', type:'pokemon', pokeId:109, name:'ドガース',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk23', type:'pokemon', pokeId:125, name:'エレブー',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk24', type:'pokemon', pokeId:126, name:'ブーバー',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk25', type:'pokemon', pokeId:127, name:'カイロス',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk26', type:'pokemon', pokeId:128, name:'ケンタロス',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk27', type:'pokemon', pokeId:129, name:'コイキング',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk28', type:'pokemon', pokeId:132, name:'メタモン',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk29', type:'pokemon', pokeId:147, name:'ミニリュウ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk30', type:'pokemon', pokeId:152, name:'チコリータ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk31', type:'pokemon', pokeId:155, name:'ヒノアラシ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk32', type:'pokemon', pokeId:158, name:'ワニノコ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk33', type:'pokemon', pokeId:209, name:'ブルー',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk34', type:'pokemon', pokeId:216, name:'ヒメグマ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk35', type:'pokemon', pokeId:231, name:'ゴマゾウ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk36', type:'pokemon', pokeId:252, name:'キモリ',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk37', type:'pokemon', pokeId:255, name:'アチャモ',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk38', type:'pokemon', pokeId:280, name:'ラルトス',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk39', type:'pokemon', pokeId:387, name:'ナエトル',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk40', type:'pokemon', pokeId:390, name:'ヒコザル',    rarity:'common',   premiumGacha:true },
  { id:'pg_pk41', type:'pokemon', pokeId:393, name:'ポッチャマ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk42', type:'pokemon', pokeId:447, name:'リオル',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk43', type:'pokemon', pokeId:495, name:'ツタージャ',  rarity:'common',   premiumGacha:true },
  { id:'pg_pk44', type:'pokemon', pokeId:498, name:'ポカブ',      rarity:'common',   premiumGacha:true },
  { id:'pg_pk45', type:'pokemon', pokeId:656, name:'ケロマツ',    rarity:'common',   premiumGacha:true },

  // uncommon (スーパーボール) 30種
  { id:'pg_pk46', type:'pokemon', pokeId:3,   name:'フシギバナ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk47', type:'pokemon', pokeId:6,   name:'リザードン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk48', type:'pokemon', pokeId:9,   name:'カメックス',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk49', type:'pokemon', pokeId:34,  name:'ニドキング',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk50', type:'pokemon', pokeId:38,  name:'キュウコン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk51', type:'pokemon', pokeId:65,  name:'フーディン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk52', type:'pokemon', pokeId:68,  name:'カイリキー',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk53', type:'pokemon', pokeId:76,  name:'ゴローニャ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk54', type:'pokemon', pokeId:78,  name:'ギャロップ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk55', type:'pokemon', pokeId:94,  name:'ゲンガー',    rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk56', type:'pokemon', pokeId:121, name:'スターミー',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk57', type:'pokemon', pokeId:123, name:'ストライク',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk58', type:'pokemon', pokeId:131, name:'ラプラス',    rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk59', type:'pokemon', pokeId:142, name:'プテラ',      rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk60', type:'pokemon', pokeId:148, name:'ハクリュー',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk61', type:'pokemon', pokeId:154, name:'メガニウム',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk62', type:'pokemon', pokeId:157, name:'バクフーン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk63', type:'pokemon', pokeId:160, name:'オーダイル',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk64', type:'pokemon', pokeId:208, name:'ハガネール',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk65', type:'pokemon', pokeId:229, name:'ヘルガー',    rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk66', type:'pokemon', pokeId:242, name:'ハピナス',    rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk67', type:'pokemon', pokeId:254, name:'ジュカイン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk68', type:'pokemon', pokeId:257, name:'バシャーモ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk69', type:'pokemon', pokeId:260, name:'ラグラージ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk70', type:'pokemon', pokeId:306, name:'ボスゴドラ',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk71', type:'pokemon', pokeId:330, name:'フライゴン',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk72', type:'pokemon', pokeId:350, name:'ミロカロス',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk73', type:'pokemon', pokeId:392, name:'ゴウカザル',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk74', type:'pokemon', pokeId:395, name:'エンペルト',  rarity:'uncommon', premiumGacha:true },
  { id:'pg_pk75', type:'pokemon', pokeId:503, name:'ダイケンキ',  rarity:'uncommon', premiumGacha:true },

  // rare (ハイパーボール) 25種
  { id:'pg_pk76', type:'pokemon', pokeId:407, name:'ロズレイド',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk77', type:'pokemon', pokeId:418, name:'ブイゼル',    rarity:'rare', premiumGacha:true },
  { id:'pg_pk78', type:'pokemon', pokeId:461, name:'マニューラ',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk79', type:'pokemon', pokeId:462, name:'ジバコイル',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk80', type:'pokemon', pokeId:466, name:'エレキブル',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk81', type:'pokemon', pokeId:467, name:'ブーバーン',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk82', type:'pokemon', pokeId:468, name:'トゲキッス',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk83', type:'pokemon', pokeId:474, name:'ポリゴンZ',   rarity:'rare', premiumGacha:true },
  { id:'pg_pk84', type:'pokemon', pokeId:475, name:'エルレイド',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk85', type:'pokemon', pokeId:497, name:'ジャローダ',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk86', type:'pokemon', pokeId:530, name:'ドリュウズ',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk87', type:'pokemon', pokeId:553, name:'ワルビアル',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk88', type:'pokemon', pokeId:609, name:'シャンデラ',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk89', type:'pokemon', pokeId:612, name:'オノノクス',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk90', type:'pokemon', pokeId:625, name:'キリキザン',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk91', type:'pokemon', pokeId:637, name:'ウルガモス',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk92', type:'pokemon', pokeId:646, name:'キュレム',    rarity:'rare', premiumGacha:true },
  { id:'pg_pk93', type:'pokemon', pokeId:671, name:'フラージェス', rarity:'rare', premiumGacha:true },
  { id:'pg_pk94', type:'pokemon', pokeId:756, name:'マシェード',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk95', type:'pokemon', pokeId:758, name:'エンニュート', rarity:'rare', premiumGacha:true },
  { id:'pg_pk96', type:'pokemon', pokeId:777, name:'トゲデマル',  rarity:'rare', premiumGacha:true },
  { id:'pg_pk97', type:'pokemon', pokeId:784, name:'カプ・コケコ', rarity:'rare', premiumGacha:true },
  { id:'pg_pk98', type:'pokemon', pokeId:797, name:'アクジキング', rarity:'rare', premiumGacha:true },
  { id:'pg_pk99', type:'pokemon', pokeId:841, name:'アップリュー', rarity:'rare', premiumGacha:true },
  { id:'pg_pk100',type:'pokemon', pokeId:842, name:'タルップル',  rarity:'rare', premiumGacha:true },

  // ultra (マスターボール) 10種
  { id:'pg_pk101',type:'pokemon', pokeId:244, name:'エンテイ',    rarity:'ultra', premiumGacha:true },
  { id:'pg_pk102',type:'pokemon', pokeId:480, name:'ユクシー',    rarity:'ultra', premiumGacha:true },
  { id:'pg_pk103',type:'pokemon', pokeId:481, name:'エムリット',  rarity:'ultra', premiumGacha:true },
  { id:'pg_pk104',type:'pokemon', pokeId:482, name:'アグノム',    rarity:'ultra', premiumGacha:true },
  { id:'pg_pk105',type:'pokemon', pokeId:485, name:'ヒードラン',  rarity:'ultra', premiumGacha:true },
  { id:'pg_pk106',type:'pokemon', pokeId:488, name:'クレセリア',  rarity:'ultra', premiumGacha:true },
  { id:'pg_pk107',type:'pokemon', pokeId:491, name:'ダークライ',  rarity:'ultra', premiumGacha:true },
  { id:'pg_pk108',type:'pokemon', pokeId:492, name:'シェイミ',    rarity:'ultra', premiumGacha:true },
  { id:'pg_pk109',type:'pokemon', pokeId:638, name:'コバルオン',  rarity:'ultra', premiumGacha:true },
  { id:'pg_pk110',type:'pokemon', pokeId:641, name:'トルネロス',  rarity:'ultra', premiumGacha:true },
]
